...
const BookForm = () => {
  ...
  const radioValue = [
    ...
    },
    {
      ...
      name: "Exams and coursework",
    },
    {
      value: "cultureTravelHobby",
      name: "Culture, travel or hobby",
    },
  ];
